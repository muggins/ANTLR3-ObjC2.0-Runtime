...
+ (void) initialize
{
 ...
 @"'{'", @"'}'", nil] retain]];
    [BaseRecognizer setGrammarFileName:@"SymbolTable.g"];
}
...
{
    self = [super initWithTokenStream:aStream State:[RecognizerSharedState newRecognizerSharedStateWithRuleLen:6+1]];
    if ( self != nil ) {
