...
+ (void) initialize
{
 ...
 @"DECL", @"FLOATTYPE", @"ID", @"INT", @"INTTYPE", @"WS", @"';'", nil] retain]];
    [BaseRecognizer setGrammarFileName:@"Lang.g"];
}
...
{
    self = [super initWithTokenStream:aStream State:[RecognizerSharedState newRecognizerSharedStateWithRuleLen:3+1]];
    if ( self != nil ) {
