...
+ (void) initialize
{
 ...
 @"ID", @"INT", @"WS", @"'enum'", nil] retain]];
    [BaseRecognizer setGrammarFileName:@"T.g"];
}
...
{
    self = [super initWithTokenStream:aStream State:[RecognizerSharedState newRecognizerSharedStateWithRuleLen:4+1]];
    if ( self != nil ) {
