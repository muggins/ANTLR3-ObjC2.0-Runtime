...
- (id<ANTLRToken>) nextToken
{
    while (YES) {
        ...
        _tokenCharPositionInLine = [input getCharPositionInLine];
        tokenStartCharIndex = [self getIndex];
        @try {
            int m = [input mark];
            backtracking = 1;
            failed = NO;
...
- (void) mIMPORT
{
    ...
    @try {
        ...
        int _nameStart31 = [self getIndex];
        [self mQIDStar];
        if (failed) return ;

        _name = [[ANTLRCommonToken alloc] initWithInput:input tokenType:ANTLRTokenTypeInvalid channel:ANTLRTokenChannelDefault start:_nameStart31 stop:[self getIndex]-1];
...
- (void) mCLASS
{
    ...
    @try {
        ...
        int _nameStart81 = [self getIndex];
        [self mID];
        if (failed) return ;

        _name = [[ANTLRCommonToken alloc] initWithInput:input tokenType:ANTLRTokenTypeInvalid channel:ANTLRTokenChannelDefault start:_nameStart81 stop:[self getIndex]-1];
        [_name setLine:[self line]];
...
- (void) mMETHOD
{
    ...
    @try {
        ...
        int _nameStart158 = [self getIndex];
        [self mID];
        if (failed) return ;

        _name = [[ANTLRCommonToken alloc] initWithInput:input tokenType:ANTLRTokenTypeInvalid channel:ANTLRTokenChannelDefault start:_nameStart158 stop:[self getIndex]-1];
        [_name setLine:[self line]];
...
- (void) mFIELD
{
    ...
    @try {
        ...
        int _nameStart261 = [self getIndex];
        [self mID];
        if (failed) return ;

        _name = [[ANTLRCommonToken alloc] initWithInput:input tokenType:ANTLRTokenTypeInvalid channel:ANTLRTokenChannelDefault start:_nameStart261 stop:[self getIndex]-1];
        [_name setLine:[self line]];
...
- (void) mCALL
{
    ...
    @try {
        ...
        {
        int _nameStart326 = [self getIndex];
        [self mQID];
        if (failed) return ;

        _name = [[ANTLRCommonToken alloc] initWithInput:input tokenType:ANTLRTokenTypeInvalid channel:ANTLRTokenChannelDefault start:_nameStart326 stop:[self getIndex]-1];
        [_name setLine:[self line]];
...
- (void) mTokens
{
    	...
    	case 'i':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:1 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case 'r':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:2 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case 'c':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:3 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case 'w':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:4 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case 's':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:5 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case 'f':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:6 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	...
    	case 'z':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:7 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    	case '/':
    		{
    			...
    			if (backtracking > 0) {failed=YES; return ;}
    		    ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:8 stream:input];
    			@throw nvae;
    			}
    		}
    		break;
    ...
    default:
     {
    	if (backtracking > 0) {failed=YES; return ;}
        ANTLRNoViableAltException *nvae = [ANTLRNoViableAltException newANTLRNoViableAltException:38 state:0 stream:input];
    	@throw nvae;
