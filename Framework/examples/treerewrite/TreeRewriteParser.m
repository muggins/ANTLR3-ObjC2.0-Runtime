...
{
    ANTLRRecognizerSharedState *_state = [self getState];
    ...
    @try {
        ...
        // 8:19: -> ^( subrule INT )
        {
            ...
            root_1 = (id)[treeAdaptor becomeRoot:(id<ANTLRTree>)[_stream_subrule next] old:root_1];
	...
	@finally {
		...
		[_stream_subrule release];
		    ...
		    [treeAdaptor setTokenBoundaries:[_retval tree] From:[_retval start] To:[_retval stop]];
		[root_0 release];
	}
	return _retval;
}
...
- (TreeRewriteParser_subrule_return *) subrule
{
    ...
    @try {
        ...
        _INT3_tree = (id)[treeAdaptor newANTLRTreeWithToken:_INT3];
