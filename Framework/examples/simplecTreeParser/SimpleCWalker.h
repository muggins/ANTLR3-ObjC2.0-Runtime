// $ANTLR ${project.version} ${buildNumber} SimpleCWalker.g 2011-05-06 15:13:21
...
@interface SimpleCWalker_expr_return :ANTLRTreeRuleReturnScope { /* returnScopeInterface line 1838 */
...
@interface SimpleCWalker : ANTLRTreeParser { /* line 572 */
...
+ (void) initialize;
+ (id) newSimpleCWalker:(id<ANTLRTreeNodeStream>)aStream;
