...
@implementation SimpleCWalker_expr_return /* returnScope */
...
+ (void) initialize
{
 ...
 @"K_SEMICOLON", @"K_VOID", @"VAR_DEF", @"WS", nil] retain]];
    [ANTLRBaseRecognizer setGrammarFileName:@"SimpleCWalker.g"];
}

+ (SimpleCWalker *)newSimpleCWalker:(id<ANTLRTreeNodeStream>)aStream
{
...
/*
 * $ANTLR start program
 * SimpleCWalker.g:13:1: program : ( declaration )+ ;
 */
- (void) program
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:14:5: ( ( declaration )+ ) // ruleBlockSingleAlt
        // SimpleCWalker.g:14:9: ( declaration )+ // alt
        {
        // SimpleCWalker.g:14:9: ( declaration )+ // positiveClosureBlock
        NSInteger cnt1 = 0;
        do {
            NSInteger alt1 = 2;
 ...
 * SimpleCWalker.g:17:1: declaration : ( variable | ^( FUNC_DECL functionHeader ) | ^( FUNC_DEF functionHeader block ) );
 */
- (void) declaration
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:18:5: ( variable | ^( FUNC_DECL functionHeader ) | ^( FUNC_DEF functionHeader block ) ) //ruleblock
        NSInteger alt2=3;
        ...
        switch (alt2) {
            case 1 : ;
                // SimpleCWalker.g:18:9: variable // alt
                {
                /* ruleRef */
                ...
                break;
            case 2 : ;
                // SimpleCWalker.g:19:9: ^( FUNC_DECL functionHeader ) // alt
                {
                ...
                break;
            case 3 : ;
                // SimpleCWalker.g:20:9: ^( FUNC_DEF functionHeader block ) // alt
                {
 ...
 * SimpleCWalker.g:23:1: variable : ^( VAR_DEF type declarator ) ;
 */
- (void) variable
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:24:5: ( ^( VAR_DEF type declarator ) ) // ruleBlockSingleAlt
        // SimpleCWalker.g:24:9: ^( VAR_DEF type declarator ) // alt
        {
 ...
 * SimpleCWalker.g:27:1: declarator : K_ID ;
 */
- (void) declarator
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:28:5: ( K_ID ) // ruleBlockSingleAlt
        // SimpleCWalker.g:28:9: K_ID // alt
        {
 ...
 * SimpleCWalker.g:31:1: functionHeader : ^( FUNC_HDR type K_ID ( formalParameter )+ ) ;
 */
- (void) functionHeader
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:32:5: ( ^( FUNC_HDR type K_ID ( formalParameter )+ ) ) // ruleBlockSingleAlt
        // SimpleCWalker.g:32:9: ^( FUNC_HDR type K_ID ( formalParameter )+ ) // alt
        {
        [self match:input TokenType:FUNC_HDR Follow:FOLLOW_FUNC_HDR_in_functionHeader171]; 
            ...
            // SimpleCWalker.g:32:30: ( formalParameter )+ // positiveClosureBlock
            NSInteger cnt3 = 0;
            do {
                NSInteger alt3 = 2;
                ...
                switch (alt3) {
                    case 1 : ;
                        // SimpleCWalker.g:32:30: formalParameter // alt
                        {
                        /* ruleRef */
 ...
 * SimpleCWalker.g:35:1: formalParameter : ^( ARG_DEF type declarator ) ;
 */
- (void) formalParameter
{
    ...
    @try {
        // SimpleCWalker.g:36:5: ( ^( ARG_DEF type declarator ) ) // ruleBlockSingleAlt
        // SimpleCWalker.g:36:9: ^( ARG_DEF type declarator ) // alt
        {
...
/*
 * $ANTLR start type
 * SimpleCWalker.g:39:1: type : ( K_INT_TYPE | K_CHAR | K_VOID | K_ID );
 */
- (void) type
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:40:5: ( K_INT_TYPE | K_CHAR | K_VOID | K_ID ) // ruleBlockSingleAlt
        // SimpleCWalker.g: // alt
        {
...
/*
 * $ANTLR start block
 * SimpleCWalker.g:46:1: block : ^( BLOCK ( variable )* ( stat )* ) ;
 */
- (void) block
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:47:5: ( ^( BLOCK ( variable )* ( stat )* ) ) // ruleBlockSingleAlt
        // SimpleCWalker.g:47:9: ^( BLOCK ( variable )* ( stat )* ) // alt
        {
        ...
        if ( [input LA:1] == DOWN ) {
            ...
            do {
                ...
                switch (alt4) {
                    case 1 : ;
                        // SimpleCWalker.g:47:17: variable // alt
                        {
                        /* ruleRef */
            ...
            do {
                ...
                switch (alt5) {
                    case 1 : ;
                        // SimpleCWalker.g:47:27: stat // alt
                        {
                        /* ruleRef */
...
/*
 * $ANTLR start stat
 * SimpleCWalker.g:50:1: stat : ( forStat | expr | block );
 */
- (void) stat
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:50:5: ( forStat | expr | block ) //ruleblock
        NSInteger alt6=3;
        ...
        switch (alt6) {
            case 1 : ;
                // SimpleCWalker.g:50:7: forStat // alt
                {
                /* ruleRef */
            ...
            case 2 : ;
                ...
                break;
            case 3 : ;
                // SimpleCWalker.g:52:7: block // alt
                {
                /* ruleRef */
...
/*
 * $ANTLR start forStat
 * SimpleCWalker.g:55:1: forStat : ^( K_FOR expr expr expr block ) ;
 */
- (void) forStat
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:56:5: ( ^( K_FOR expr expr expr block ) ) // ruleBlockSingleAlt
        // SimpleCWalker.g:56:9: ^( K_FOR expr expr expr block ) // alt
        {
...
/*
 * $ANTLR start expr
 * SimpleCWalker.g:59:1: expr : ( ^( K_EQEQ expr expr ) | ^( K_LT expr expr ) | ^( K_PLUS expr expr ) | ^( K_EQ K_ID e= expr ) | atom );
 */
- (SimpleCWalker_expr_return *) expr
{
    ...
    @try {
        ANTLRCommonTree *K_ID1 = nil;
         SimpleCWalker_expr_return * e = nil ;
         

        // SimpleCWalker.g:59:5: ( ^( K_EQEQ expr expr ) | ^( K_LT expr expr ) | ^( K_PLUS expr expr ) | ^( K_EQ K_ID e= expr ) | atom ) //ruleblock
        NSInteger alt7=5;
        ...
        switch (alt7) {
            case 1 : ;
                // SimpleCWalker.g:59:9: ^( K_EQEQ expr expr ) // alt
                {
                ...
                break;
            case 2 : ;
                // SimpleCWalker.g:60:9: ^( K_LT expr expr ) // alt
                {
                ...
                break;
            case 3 : ;
                // SimpleCWalker.g:61:9: ^( K_PLUS expr expr ) // alt
                {
                ...
                break;
            case 4 : ;
                // SimpleCWalker.g:62:9: ^( K_EQ K_ID e= expr ) // alt
                {
...
/*
 * $ANTLR start atom
 * SimpleCWalker.g:66:1: atom : ( K_ID | K_INT );
 */
- (void) atom
{
    /* my ruleScopeSetUp */
    ...
    @try {
        // SimpleCWalker.g:67:5: ( K_ID | K_INT ) // ruleBlockSingleAlt
        // SimpleCWalker.g: // alt
        {
