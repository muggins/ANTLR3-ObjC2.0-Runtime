...
+ (id) newDFA2WithRecognizer:(BaseRecognizer *)aRecognizer
{
...
+ (void) initialize
{
 ...
 @"K_SEMICOLON", @"K_VOID", @"VAR_DEF", @"WS", nil] retain]];
    [BaseRecognizer setGrammarFileName:@"SimpleC.g"];
}
...
{
    self = [super initWithTokenStream:aStream State:[RecognizerSharedState newRecognizerSharedStateWithRuleLen:15+1]];
    if ( self != nil ) {
...
- (SimpleCParser_forStat_return *) forStat
{
    ...
    @try {
        ...
        // AST REWRITE
        // elements: expr, block, next, K_FOR, start
        // token labels: 
