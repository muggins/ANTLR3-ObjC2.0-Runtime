...
- (void) setUp {
  lastTestFailed = NO;
  tmpdir = [[[[File alloc] init:[System getProperty:@"java.io.tmpdir"] param1:[[@"antlr-" stringByAppendingString:[[self class] name]] stringByAppendingString:@"-"] + [System currentTimeMillis]] autorelease] absolutePath];
...
- (BOOL) compile:(NSString *)fileName {
  ...
  NSArray * args = [NSArray arrayWithObjects:compiler, @"-d", tmpdir, classpathOption, [[tmpdir stringByAppendingString:pathSep] stringByAppendingString:CLASSPATH], [[tmpdir stringByAppendingString:@"/"] stringByAppendingString:fileName], nil];
  NSString * cmdLine = [[[[[[[[[[compiler stringByAppendingString:@" -d "] stringByAppendingString:tmpdir] stringByAppendingString:@" "] stringByAppendingString:classpathOption] stringByAppendingString:@" "] stringByAppendingString:tmpdir] stringByAppendingString:pathSep] stringByAppendingString:CLASSPATH] stringByAppendingString:@" "] stringByAppendingString:fileName];
